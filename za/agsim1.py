...
class TrajectorySimulator:
    def __init__(self, folder_idx, n, trajectory_file, initial_prob_file, length_prob_file, markov_chain_file, output_file):
        ...
        self.ensure_file_exists(self.trajectory_file, "轨迹文件")
        self.ensure_file_exists(self.initial_prob_file, "初始分布文件")
        self.ensure_file_exists(self.length_prob_file, "长度分布文件")
        self.ensure_file_exists(self.markov_chain_file, "马尔可夫链文件")
